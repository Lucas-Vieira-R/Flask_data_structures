...
# SQLAlchemy nos ajuda a lidarmos com o banco de dado utilizando de POO, tratando as entidades do BD como objetos!!
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///sqlitedb.file"
app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = 0

#configurar SQLite3 para permitir chaves estrangeiras
...
def create_user():
    ...
    db.session.commit()
    return jsonify({"message":"User %s created" %data["name"]}),200

# Aqui implementaremos a Lista Linkada aka LinkedList:
# Usuarios com o id em ordem decrescente
...
# Usuarios com o id em ordem crescente
...
# retorna Usuario com id especifico
...
def get_one_user(user_id):
    ...
    if user:
        ...
        return jsonify("Cannot Find user, id dont exist")

# deleta um usuario com o id específico
